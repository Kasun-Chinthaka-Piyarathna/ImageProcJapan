...
public class CameraCailbration {
    ...
    ArrayList vCorners;
    ArrayList<Mat> vImg = new ArrayList();
    //    ArrayList vImg;
    ...
    CameraCailbration(Size patternSize) {
    ...
    static void test0() {
        CameraCailbration cb = new CameraCailbration(new Size(8, 6));
        cb.getAllCornors("/home/chinthaka/Downloads/wow/wow");
        cb.calibrate();
    }
    ...
    void getAllCornors(String path) {
        ...
        for (File f : new File(path).listFiles()) {
            Mat mat = Imgcodecs.imread(f.getPath(),
